...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center py-8 bg-[#1a2036] w-full">
    ...
    <div className="flex justify-center items-center w-[90%] sm:w-[40%] bg-[#171721] rounded-xl shadow-md shadow-indigo-400" >
      <form ref={form} onSubmit={sendEmail} className="flex flex-col  py-6 w-[90%] ">
        ...
        <input className=" mb-6 py-1 rounded-sm px-2 text-lg font-semibold bg-gray-200" type="text" name="user_name" placeholder="Your Name..."  value={name} onChange={(e) => setName(e.target.value)} />
        ...
        <textarea className=" mb-6 py-1 h-[100px] rounded-sm px-2 text-lg font-semibold bg-gray-200 " name="message" placeholder="Message..." value={message} onChange={(e) => setMessage(e.target.value)}  />
